...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.company'
        db.add_column(u'core_person', 'company',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Person.position'
        db.add_column(u'core_person', 'position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.company'
        db.delete_column(u'core_person', 'company')

        # Deleting field 'Person.position'
        db.delete_column(u'core_person', 'position')
