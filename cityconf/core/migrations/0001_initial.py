...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_city', (
            ...
            ('location_lon', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.create_table(u'core_person', (
            ...
            ('loc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.City'])),
        ))
        ...
        db.create_table(u'core_conference', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.City'])),
            ('chairman', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Person'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('is_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'core', ['Conference'])

        # Adding M2M table for field team on 'Conference'
        db.create_table(u'core_conference_team', (
        ...
        db.create_unique(u'core_conference_team', ['conference_id', 'person_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field team on 'Conference'
        db.delete_table('core_conference_team')
    ...
    models = {
        ...
        u'core.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.City']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
