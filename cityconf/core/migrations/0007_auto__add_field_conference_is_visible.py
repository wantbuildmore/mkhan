...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.is_visible'
        db.add_column(u'core_conference', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conference.is_visible'
        db.delete_column(u'core_conference', 'is_visible')
